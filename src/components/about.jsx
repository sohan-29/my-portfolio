...
const AboutMe = () => {
  ...
  return (
    <>
      ...
      <section id="about" className={`flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-11 bg-[#2b2b2b] text-white p-5 px-[7vw] h-full min-h-screen overflow-hidden` + (location.pathname.includes("about") ? " overflow-hidden" : "")}>
        ...
        <div className="relative w-8/9 sm:w-6/9 md:mt-17 text-center sm:text-left text-gray-300">
          ...
          <div className="tab-content-container mt-6 lg:min-h-[55vh]">
            {renderTabContent()}
          </div>
        </div>
      </section>
