...
const Contact = () => {
  return (
    ...
    <div className="relative min-h-screen flex fext-col items-center justify-center bg-[#292929] text-white">
      ...
      <div className="absolute top-157 right-[9vw] w-47 h-47 md:top-147 md:right-11 md:w-30 md:h-30 lg:top-147 lg:right-22 lg:w-33 lg:h-33 xl:top-196 xl:right-29 xl:w-44 xl:h-44 bg-[#ca1931bd] rounded-full"></div>
      <div className="absolute top-147 left-[9vw] w-47 h-47 md:top-148 md:left-6 md:w-33 md:h-33 lg:top-144 lg:left-9 lg:w-39 lg:h-39 xl:top-187 xl:left-29 xl:w-49 xl:h-49 bg-[#ca1931bd] rounded-full"></div>
      <div className="absolute top-26 right-[7vw] w-11 h-11 bg-[#ca19316a] md:top-143 md:bottom-auto md:right-11 md:w-12 md:h-12 lg:top-143 lg:right-19 lg:w-13 lg:h-13 xl:top-188 xl:right-24 xl:w-22 xl:h-22 sm:bg-[#ca19319b] rounded-full"></div>
      </div>
