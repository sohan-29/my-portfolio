...
const Skills = () => {
  ...
  return (
    <>
      ...
      <div className={`flex flex-col p-4 shadow-md bg-[#2e2e2e] text-white px-[7vw] h-full min-h-screen ${location.pathname.includes("skills") ? "overflow-hidden" : ""}`}>
        ...
        <div className="relative sm:mt-10">
          ...
          <div className="absolute top-169 right-[57vw] w-47 h-47 | md:top-101 md:right-18 md:w-33 md:h-33 | lg:top-99 lg:right-59 lg:w-36 lg:h-36 | xl:top-109 xl:right-69 xl:w-44 xl:h-44 bg-[#ca1931ad] rounded-full"></div>
