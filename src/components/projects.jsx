...
const Projects = () => {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen flex flex-col items-center bg-[#2b2b2b] text-white ${location.pathname.includes("projects") ? "overflow-hidden" : ""}`}>
        ...
        <div className="relative sm:mt-10">
          ...
          <div className="absolute top-3 right-[16vw] w-33 h-33 md:top-auto md:bottom-36 md:left-61 md:w-10 md:h-10 lg:top-auto lg:bottom-43 lg:left-67 lg:w-11 lg:h-11 xl:bottom-42 xl:top-auto xl:left-93 xl:w-13 xl:h-13 bg-[#bf162dad] rounded-full"></div>
          <div className="absolute top-87 left-[18vw] w-23 h-23 md:top-auto md:bottom-22 md:left-64 md:w-22 md:h-22 lg:bottom-24 lg:left-69 lg:w-26 lg:h-26 xl:bottom-18 xl:left-96 xl:w-33 xl:h-33 bg-[#da19317d] z-0 rounded-full"></div>
        </div>
